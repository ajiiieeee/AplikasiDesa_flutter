...
class KadesMonitoringPengaduanScreen extends StatefulWidget {
  ...
  @override
  State<KadesMonitoringPengaduanScreen> createState() =>
      _KadesMonitoringPengaduanScreenState();
}

class _KadesMonitoringPengaduanScreenState
    extends State<KadesMonitoringPengaduanScreen> {
            ...
            return Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _detailRow('Status', item.isResponded ? 'Sudah Ditanggapi Admin' : 'Belum Ditanggapi'),
                  const SizedBox(height: 12),
                  Text('Isi Laporan Pengaduan:',
                  ...
                  const SizedBox(height: 16),
                  Text('Tanggapan / Feedback Admin Desa:',
                      style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 13, color: const Color(0xFF263238))),
                  const SizedBox(height: 8),
                  Container(
                    width: double.infinity,
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Text('MONITORING PENGADUAN (KADES)',
              style: GoogleFonts.poppins(
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text('Belum Ada Pengaduan Masyarakat',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(item.createdAt.isNotEmpty ? item.createdAt : 'Baru Saja',
